...
namespace Morphy_Pathfinding._Scripts {
    public static class Pathfinding {
        // Uncomment everything if you want to see path visualisation
        ...
        public static List<NodeBase> FindPath(NodeBase startNode, NodeBase targetNode, List<NodeBase> allies) {
            ...
            while (toSearch.Any()) {
                ...
                foreach (var neighbor in current.Neighbors.Where(t => t.Walkable && !allies.Contains(t) && !processed.Contains(t))) {
